...
# url1 = 'https://drive.google.com/file/d/1ejRrRrn769Z2usxme0ucx1HJTx3lCF4a/view?usp=sharing'
# path1 = 'https://drive.google.com/uc?export=download&id='+url1.split('/')[-2]
# activity_min = pd.read_csv(path1)
path1 = st.file_uploader("UPLOAD ACTIVITY_MINUTE FILE", type={"csv", "txt"})
if path1 is not None:
    activity_min = pd.read_csv(path1)
st.write(activity_min)

# url2 = 'https://drive.google.com/file/d/1TyQmyAYJuVlcZ_M6DaIUx7eaG7XSRHIv/view?usp=sharing'
# path2 = 'https://drive.google.com/uc?export=download&id='+url2.split('/')[-2]
# heartrate_auto = pd.read_csv(path2)
path2 = st.file_uploader("UPLOAD HEARTRATE_AUTO FILE", type={"csv", "txt"})
if path2 is not None:
    heartrate_auto = pd.read_csv(path2)
st.write(heartrate_auto)

# url3 = 'https://drive.google.com/file/d/1FndcEVMcwdiT1Rcr7AVVZfAOPt9S7Wuh/view?usp=sharing'
# path3 = 'https://drive.google.com/uc?export=download&id='+url3.split('/')[-2]
# user = pd.read_csv(path3)
path3 = st.file_uploader("UPLOAD USER FILE", type={"csv", "txt"})
...
# Create the model
regressor = MLPRegressor(hidden_layer_sizes=(70,), max_iter=1000, random_state=0)
...
try:
    ...
    st.write("Please enter the correct date and time format.")